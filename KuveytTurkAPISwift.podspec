#
#  Be sure to run `pod spec lint KuveytTurkAPISwift.podspec' to ensure this is a
...
*Note: This sample does not necessarily demonstrate the best use but rather features of using Kuveyt Turk API Banking iOS SDK. Always remember to handle exceptions.*
  ...
  s.author             = { "Mustafa Tanışır / Kuveyt Türk - BT-Dijital Bankacılık Yazılım Geliştirme" => "mustafa.tanisir@kuveytturk.com.tr" }
  # Or just: s.author    = "Mustafa Tanışır / Kuveyt Türk - BT-Dijital Bankacılık Yazılım Geliştirme"
  # s.authors            = { "Mustafa Tanışır / Kuveyt Türk - BT-Dijital Bankacılık Yazılım Geliştirme" => "mustafa.tanisir@kuveytturk.com.tr" }
  # s.social_media_url   = "http://twitter.com/Mustafa Tanışır / Kuveyt Türk - BT-Dijital Bankacılık Yazılım Geliştirme"
